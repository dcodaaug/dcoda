...
def extract_obs_bimanual(
    ...
    # NOTE: not sure why the demonstrations have this information but training does not require them
    if 'front_pose' in obs_dict:
        del obs_dict['front_pose']
    if 'over_shoulder_left_pose' in obs_dict:
        del obs_dict['over_shoulder_left_pose']
    if 'over_shoulder_right_pose' in obs_dict:
        del obs_dict['over_shoulder_right_pose']
    if 'overhead_pose' in obs_dict:
        del obs_dict['overhead_pose']
    if 'wrist_left_pose' in obs_dict:
        del obs_dict['wrist_left_pose']
    if 'wrist_right_pose' in obs_dict:
        del obs_dict['wrist_right_pose']
