...
def load_clip(
    ...
    try:
        # training uses this relative file path
        model = torch.load('../../../data/clip_rn50.pth', weights_only=True)
    except:
        # this exception can happen when you're doing evaluation (os.getcwd() is different when doing eval)
        # if this still fails, then it means you don't have this file in the 'bimani/peract/data' folder
        model = torch.load('../../../../data/clip_rn50.pth', weights_only=True)
    n_px = 224
