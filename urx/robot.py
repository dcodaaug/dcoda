...
class Robot(URRobot):
    ...
    def servoj_robot(self, tjoints, acc, vel, t, lookahead_time, gain, wait=False, relative=False, threshold=None):
        """
        Move Joint: Move to joint position
        see UR documentation
        """
        URRobot.servoj(self, tjoints, acc=acc, vel=vel, t=t, lookahead_time=lookahead_time, gain=gain, wait=wait, relative=relative, threshold=threshold)
