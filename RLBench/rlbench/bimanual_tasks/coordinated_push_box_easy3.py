...
class CoordinatedPushBoxEasy3(BimanualTask):
    ...
    def init_episode(self, index) -> List[str]:
        ...
        b.clear()
        b.sample(Dummy('coordinated_push_box_easy3'), min_rotation=(0.0, 0.0, -angle), max_rotation=(0.0, 0.0, angle), min_distance=0.0)
