...
class CoordinatedLiftTrayEasy6(BimanualTask):
    ...
    def init_episode(self, index) -> List[str]:
        ...
        b.clear()
        b.sample(Dummy('coordinated_lift_tray_easy6'), min_rotation=(0.0, 0.0, 0.0), max_rotation=(0.0, 0.0, 0.0), min_distance=0.0)
    ...
    def boundary_root(self) -> Object:
        return Dummy('coordinated_lift_tray_easy6')
